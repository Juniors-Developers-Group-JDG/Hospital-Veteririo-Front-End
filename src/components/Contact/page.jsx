        ...
        <div className={styles.section_left_text}>
          ...
          <p>
            <a href="tel:11999999999">
              <BsFillTelephoneFill /> (11) 99999-9999
            </a>
          </p>
          <p>
            <a href="https://api.whatsapp.com/send?phone=5511999999999">
              <BsWhatsapp /> (11) 99999-9999
            </a>
          </p>
          <p>
            <a href="https://goo.gl/maps/9Z1J1Y7Y1Z2Z9Z1J6">
              <FiMap /> Rua dos Bobos, 0 - São Paulo - SP
            </a>
          </p>
          <button>
            <a href="https://encurtador.com.br/dsGJ6">
              <LuMapPin /> Como chegar
            </a>
          </button>
        </div>
      </section>
